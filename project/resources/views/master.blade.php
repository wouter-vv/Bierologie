...
<div id="wrapper" class="container">
    <section class="navbar main-menu">
        <div class="navbar-inner main-menu">
            ...
            <nav id="menu" class="pull-right">
                <ul>
                    <li><a href="./products.html">Spotlight</a></li>
                    <li><a href="./products.html">All beers</a></li>
                    <li><a href="./products.html">My beers</a></li>
    ...
    <footer>&copy; {{ \Carbon\Carbon::now()->year }} &mdash; Ikdoeict.be
